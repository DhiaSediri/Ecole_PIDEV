...
use Esprit\ScolariteBundle\Entity\Salle;
...
class SalleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $salles = $em->getRepository('EspritScolariteBundle:Salle')->findAll();
    ...
    {
        $salle = new Salle();
        $form = $this->createForm('Esprit\ScolariteBundle\Form\SalleType', $salle);
    ...
    {
        $deleteForm = $this->createDeleteForm($salle);
        $editForm = $this->createForm('Esprit\ScolariteBundle\Form\SalleType', $salle);
     ...
     *
     * @Route("/DELETE/{id}", name="salle_delete")
     * @Method("GET")
     */

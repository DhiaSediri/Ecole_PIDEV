...
use Esprit\ScolariteBundle\Entity\Matiere;
...
class MatiereController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $matieres = $em->getRepository('EspritScolariteBundle:Matiere')->findAll();
    ...
    {
        $matiere = new Matiere();
        $form = $this->createForm('Esprit\ScolariteBundle\Form\MatiereType', $matiere);
    ...
    {
        $deleteForm = $this->createDeleteForm($matiere);
        $editForm = $this->createForm('Esprit\ScolariteBundle\Form\MatiereType', $matiere);
